...
const HERO_IMAGE = "/saveit-hero.png";
        ...
        <div className="mx-auto px-4" style={{ maxWidth: MAX }}>
          ...
          <div className="mx-auto mt-10 grid max-w-[760px] gap-4">
            {[
              {
                q: "정산은 언제 되나요?",
                a: "고객이 예약한 상품을 픽업할 때, 매장 현장에서 결제합니다. 정산에 별도 소요되는 시간이 없습니다.",
              },
              {
                q: "직접 배달해야 하나요?",
                a: "픽업/현장 수령하는 고객들을 위한 서비스로, 아직 배달을 지원하고 있지 않습니다.",
              },
              {
                q: "상품 등록은 어떻게 하나요?",
                a: "앱 내에서 가능하며, 제품 사진과 가격 등을 입력해 손쉽게 등록이 가능합니다.",
              },
              {
                q: "가격은 제가 정하나요?",
                a: "서비스에서 지정하는 최소 할인율만 준수하시면, 자유롭게 정하실 수 있습니다.",
              },
              {
                q: "고객이 환불을 요청하면 어떻게 되나요?",
                a: "매장 내의 운영 원칙에 따라 처리하시면 되며, 이는 앱 내 매장 페이지에 사전 고지할 수 있습니다.",
              },
              {
                q: "가입 및 시작 비용이 있나요?",
      ...
      <footer className="border-t border-[var(--c-border)] bg-white">
        <div className="mx-auto px-4 py-12" style={{ maxWidth: MAX }}>
          <div className="grid gap-10 md:grid-cols-[1fr_2fr]">
            ...
            <div className="space-y-3 text-[13px] text-[var(--c-muted)]">
              <div>비비(BB)컴퍼니는 통신판매중개자로서 통신판매의 당사자가 아니며 개별 판매자가 제공하는 서비스에 대한 이행, 계약사항 등과 관련한 의무와 책임은 거래당사자에게 있습니다.
</div>
